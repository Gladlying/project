...
*/
	function success(){
		...
		*/							
		//设置页面的出现
		$(".m-page").eq(page_n-1).removeClass("show active").addClass("hide").find("p").removeClass(function(){return $(this).attr("data-m")});
		$(".m-page").eq(newM-1).removeClass("active hide").addClass("show").find("p").addClass(function(){return $(this).attr("data-m")});
